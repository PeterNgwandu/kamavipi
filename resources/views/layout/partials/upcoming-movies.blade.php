        ...
        <div class="row">
            <div class="col-md-9">
                <div class="upcomming-featured">
                    <img class="img-responsive" src="images/movies/upcomming-featured.png" alt="Upcomming Featured">
            ...
            <div class="col-md-3 col-xs-12 sm-top-30">
                <div class="upcomming-item">
                    <img class="img-responsive" src="images/movies/upcomming-1.png" alt="Upcomming featured">
                    <div class="upcomming-details">
                ...
                <div class="upcomming-item">
                    <img class="img-responsive" src="images/movies/upcomming-2.png" alt="Upcomming">
                    <div class="upcomming-details">
                ...
                <div class="upcomming-item">
                    <img class="img-responsive" src="images/movies/upcomming-3.png" alt="upcomming">
                    <div class="upcomming-details">
